...
export const ProjectsProvider = props => {
    ...
    return (
        < ProjectsContext.Provider value={ { projects, index, setIndex, cases } }>
            {props.children}
