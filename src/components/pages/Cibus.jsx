        ...
        <div className="project-page" onScroll={scrollInfo.onScroll}>
            ...
            <section  className="grid-column project-problem" style={{backgroundImage: `url(${ProblemTop}), linear-gradient(#FF9438, #FF4400), url(${ProblemBottom})`}}>
                ...
                <span className="project-description">
                    We determined that our main goal was improving the usability to prevent bad 
                    experiences and avoid waiting by simplifying the user interfaces as well as 
                    improving attributes like wayfinding and findability.<br/><br/>

                    The requirements for the success of the project was:<br/><br/>
                    <ul className="project-description">
                        <li>Reduce the number of people who need technical support.</li>
                        ...
                        <li>Reduce the difficulty of learning the system.</li>
                    </ul>
                </span>
            </section>
            <section className="grid-column">
                ...
                <span className="project-description">
                    The first step was understanding the problem, so I conducted interviews 
                    to discover how they feel using the previous system, therefore knowing what 
                    contents preserve, what we could do better, and what features weren't necessary 
                    for the restaurant sector.<br/><br/>

                    After I knew how is the experience using the previous system, I decided to run a 
                    tree-testing or invert card-sorting to see if the users could navigate easily and 
                    find certain locations to perform daily tasks, thus I could see the problems with 
                    the information architecture.<br/><br/>

                    The users had no problems locating the most essential task, but they had a hard time 
                    finding the complementary ones. For example, one of the tasks I gave to the users was 
                    "to locate where you could create an item of the inventory" which were able to complete 
                    easy, but when I gave them the next task of "locating where you could create a recipe with 
                    the inventory items" they just got lost. <br/><br/>

                    One of the reasons for such a raise of difficulty between tasks was the naming. Instead of 
                    using descriptive names easy to understand or standard words, the system has its own words and 
                    terminologies which only the company considers standard.<br/><br/>

                    Another factor that contributed to disorienting the users was the misplacement of some options, 
                    making them find the solution in every group until they reach the option they wanted it.<br/><br/>
                </span>
            
                <h2 className="project-subtitle">information architecture</h2>
                <span className="project-description">
                    Based on the interviews, card-sorting, and tree-testing with the users and team members, 
                ...
                <span className="project-description">
                    Once knowing the information that Cibus was going to have, I began to 
                    make low fidelity prototypes section by section on one-week sprints, 
                    creating small clickables wireflows and then run usability tests to them.  
                </span>
                <img className="project-img" style={{margin: "0 8.5% 16em", maxWidth: "83%"}} src={Proto} alt="Cibus Prototype"/>

                
                <h2 className="project-subtitle">A/B test, My savior</h2>
                <span className="project-description">
                    the usability test that suited the most was A/B testing because I could prove 
                    two different versions of the wireflows for each display, one totally different 
                    from the old system with new forms of interaction and another with fewer changes, 
                    preserving the way they used to interact with some key functionalities.<br/><br/>
                ...
                <span className="project-description">
                    I wanted Cibus to be modern and elegant, but with some color and fun at the same time, 
                    so I decided to used a minimalistic style like Material design 2 or crystal design with 
                    some modifications.<br/><br/>

                    The buttons, icons, and menus had to be larger than another system to reduce errors due 
                    to the small 10 inches screens which the customers use.<br/><br/>
            ...
            <section className="grid-column">
                ...
                <span className="project-description">
                    Finally, after various UX cycles, we got the definitive wireflow done and 
                    all the low fidelity prototypes designed and tested, so it was time to give a 
                    little of magic to Cibus.<br/><br/>

                    Cibus accomplished all the main goals that we established at the beginning of the 
                    project. The process is on average 100% faster than before, even at some task like 
                    the recipe part is 250% faster. It's easier to understand, making not only the process 
                    clearer but encouraging the users to use or discover features that they or didn't use 
                    it or totally ignore due to the frustration to try to understand them.<br/><br/>

                    Finally but not less important, we lowered the complexity of the system improving the 
                    learning curve and making it easier to understand, which dropped the support calls to 
                    400% less than before.<br/><br/>

                    Even though the complexity of creating a new system was a tough challenge at first, All 
                    people from the customers to the group members of Evolution POS and me are all satisfied 
                    with the end result. It took us nine months to complete the project, 3 months less than 
                    we planned it.<br/><br/>

                    It's a great change in the form we all work, but one which will carry the company and its 
